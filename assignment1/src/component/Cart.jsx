...
export const Cart = () => {
  ...
  return (
    <>
      <div>
        <h1>Total Product : {cartCount}</h1>
      </div>
      {!cartCount == 0 ? (
        <div className="flex flex-wrap gap-8 mt-4 px-4 justify-center sm:justify-start h-[101vh] ">
                ...
                {!cart.includes(product) ? (
                  ...
                  <div className="mt-2">
                    <button
                      ...
                      onClick={() => {
                        setCart(
                          cart.filter((cartprod) => cartprod.id !== product.id)
                        );
                      }}
                    >
                      remove from cart
        ...
        <h1 className="h-[101vh]">Nothing to show....</h1>
      )}
    </>
  );
};
